  ...
  return (
    ...
    <main>
      <Section 
        ...
        imageDesktop={illustrationEditorDesktop}
        imageMobile={illustrationEditorMobile} 
      />
      <Section
        ...
        imageDesktop={illustrationLaptopDesktop}
        imageMobile={illustrationLaptopMobile}
      />
      <Section
        ...
        imageDesktop={illustrationPhones}
      />
      <Section
